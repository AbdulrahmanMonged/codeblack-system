...
- In the recovered local workspace used for reconstruction (`/home/bodyy/REDACTED-bot-recovered-20260220`), dependencies still need reinstall in the active Python runtime before running `alembic heads/current`.
